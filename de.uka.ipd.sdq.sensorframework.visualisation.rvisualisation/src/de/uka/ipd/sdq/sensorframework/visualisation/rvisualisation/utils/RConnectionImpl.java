...
//				MessageDialog.INFORMATION, new String[] { "OK" }, 0).open();
	...
	/* (non-Javadoc)
	 * @see de.uka.ipd.sdq.sensorframework.visualisation.rvisualisation.utils.IRConnection#execute(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.uka.ipd.sdq.sensorframework.visualisation.rvisualisation.utils.IRConnection#assign(java.lang.String, double[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.uka.ipd.sdq.sensorframework.visualisation.rvisualisation.utils.IRConnection#getLastConsoleMessage()
	 */
	@Override
