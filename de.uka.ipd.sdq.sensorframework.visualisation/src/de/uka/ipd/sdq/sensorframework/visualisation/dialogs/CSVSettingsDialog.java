...
public class CSVSettingsDialog extends Dialog {
    ...
    public CSVSettingsDialog(String pathParentDir, String fileOrDirName, String fileExtension, DialogType type) {
        ...
        super(PlatformUI.getWorkbench().getActiveWorkbenchWindow().getShell(), SWT.APPLICATION_MODAL | SWT.DIALOG_TRIM);
        setText("SWT Dialog");
    ...
    public boolean getValidPath() {
        String pathDir = "";
        /*
         * If the directory doesn't exist, then it will be created. If the directory exists, then a
         * message box ask to overwrite it.
         */
