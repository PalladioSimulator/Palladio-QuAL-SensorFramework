...
public class ConfigEditorInput extends Observable implements IEditorInput, IPersistableElement, IAdaptable, Observer {
    ...
    public void saveState(IMemento memento) {
        try {
            ...
            /*
             * ignore errors if they happen, most likely the corresponding sensor entities have been
             * deleted meanwhile
             */
        }
    }
    ...
    /**
     * Set the status of this class to changed and notifies all listening observers.
     */
    ...
    /**
     * Return absolute path of the config file. It develops out location in the local file system of
     * the plug-in state area for this plug-in and defined name.
     * 
