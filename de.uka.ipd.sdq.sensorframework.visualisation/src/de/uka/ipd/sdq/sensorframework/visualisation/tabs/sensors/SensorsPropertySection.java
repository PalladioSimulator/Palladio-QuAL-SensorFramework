...
public class SensorsPropertySection extends AbstractPropertySection implements Observer {
    ...
    protected static String[] columnNames = new String[] {
            ICON_COLUMN, CONTEXT_COLUMN, RUN_COLUMN, SENSORS_COLUMN
    };
    ...
    public void createControls(Composite parent, TabbedPropertySheetPage aTabbedPropertySheetPage) {
        ...
        addRunItem.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                if (dialog.open() == Window.OK && dialog.getResult() != null) {
                    ...
                    ConfigEntry configEntry = new ConfigEntry(object.getDatasource(), (ExperimentRun) object
                            .getObject(), object.getExperiment(), null);
        ...
        AbstractReportView view = (AbstractReportView) VisualisationPlugin.getDefault().getWorkbench()
