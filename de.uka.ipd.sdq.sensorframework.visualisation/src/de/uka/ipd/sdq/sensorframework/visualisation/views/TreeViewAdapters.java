...
class ExperimentsAdapter implements ISelectionChangedListener {
    ...
    /**
     * Adds actions to the menu if the selection is a single experiment. This method is called every
     * time the user right clicks to open a popup menu.
     * 
     * @param manager
    ...
    /**
     * Adds actions to the toolbar which should then be enabled and disabled when the selection
     * changes.
     * 
     * @param toolbar
     *            the toolbar to add actions to
     */
    ...
    private List<Experiment> getSelectedExperiments() {
        ...
        IStructuredSelection selection = (IStructuredSelection) myChildTree.getSelection();
    ...
    /**
     * Action that deletes all selected Experiments and their contents. Note: Currently Experiments
     * are stored as part of ExperimentAndDAO, so these will be deleted instead of just the
     * experiment.
     */
    ...
    /**
     * Action that pops up a dialog to rename an experiment. Only runs, if exacly one experiment and
    ...
    private class RenameAction extends Action {
        ...
        public void run() {
            ...
            InputDialog dlg = new InputDialog(Display.getCurrent().getActiveShell(), "Rename experiment",
                    "Enter the new experiment name!", experiment.getExperimentName(), new NameValidator());
