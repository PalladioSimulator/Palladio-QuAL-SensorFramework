...
public class VisualisationImages {
    ...
    static {
        ...
        imageRegistry.put(RUN, getImageDescriptor(iconPath + RUN + ".gif"));
        imageRegistry.put(SENSOR, getImageDescriptor(iconPath + SENSOR + ".gif"));
        imageRegistry.put(SENSORS, getImageDescriptor(iconPath + SENSORS + ".gif"));
        imageRegistry.put(RUNS, getImageDescriptor(iconPath + RUNS + ".gif"));
        imageRegistry.put(EXPERIMENT, getImageDescriptor(iconPath + EXPERIMENT + ".gif"));
        imageRegistry.put(TREEROOT, getImageDescriptor(iconPath + TREEROOT + ".gif"));
        imageRegistry.put(CHECKED_IMAGE, getImageDescriptor(iconPath + CHECKED_IMAGE + ".gif"));
        imageRegistry.put(UNCHECKED_IMAGE, getImageDescriptor(iconPath + UNCHECKED_IMAGE + ".gif"));
