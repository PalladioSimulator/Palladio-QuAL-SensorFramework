...
public class FiltersPropertySection extends AbstractPropertySection {
    ...
    protected static String[] columnNames = new String[] {
            ICON_COLUMN, FILTERNAME_COLUMN, PARAMETER_TYPE_COLUMN, PARAMETER_DESCRIPTION_COLUMN, PARAMETER_VALUE_COLUMN
    };
    ...
    public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
        ...
        composite.getParent().setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true));
        ...
        viewer.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                ...
                if (object instanceof IFilteredCollectionFactory) {
                    ...
                    int index = configObject.getFiltersManager().getFactories().indexOf(selectedFactory);
                    if (index == 0) {
                        upItem.setEnabled(false);
                    }
                    if (index == configObject.getFiltersManager().getFactories().size() - 1) {
        ...
        addRunItem.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent event) {
                ...
                ActionListSelectionDialog dialog = new ActionListSelectionDialog(event.display.getActiveShell(),
        ...
        upItem.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ArrayList<IFilteredCollectionFactory> factories = configObject.getFiltersManager().getFactories();
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.ui.views.properties.tabbed.AbstractPropertySection#setInput(org.eclipse.ui.
