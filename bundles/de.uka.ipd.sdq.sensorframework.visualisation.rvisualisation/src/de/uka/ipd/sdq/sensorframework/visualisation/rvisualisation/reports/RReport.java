...
public abstract class RReport {
    ...
    /**
     * Template method for subclasses to implement. Subclasses can create IReportItems from the
     * given <code>SensorAndMeasurements</code>. They can use the
     * <code>storeMeasurementsInRVector(SensorAndMeasurements, int)
     * </code> to transfer data to R.
     * 
     * @param measurements
     *            List of the measurements for a sensor.
     * @param rConnection
     *            connection to the R engine.
     * @return List of Items.
     */
    public abstract ArrayList<IReportItem> prepareReportItems(Collection<SensorAndMeasurements> measurements,
