...
public class HistogramReportItem extends AbstractPlotReportItem {
    ...
    /**
     * Constructs a new report item containing a histogram graphic. The graphic is stored in a
     ...
     *            Label for the x axis.
     */
    public HistogramReportItem(final String title, final int height, final int width, final int fontSize,
    ...
    protected String generatePlotCommand() {
        ...
        rCommand += list;
        rCommand += legend;
        rCommand += "multhist(l, breaks=" + columns + ", freq=FALSE, probability=TRUE," + "main=\"" + getDescription()
                + "\", " + "title=\"Histogram\", " + "xlab=\"" + xAxisLabel + "\", " + "ylab=\"Probability\"";
