...
public class HTMLVisitor implements IReportRenderingVisitor {
     ...
     * {@inheritDoc}
     */
    public void visitStaticTextReportItem(final StaticTextReportItem staticReportItem) {
     ...
     * {@inheritDoc}
     */
    public void visitGeneratedTextReportItem(final RCommandRReportItem rCommandReportItem) {
     ...
     * {@inheritDoc}
     */
    public void visitGraphicReportItem(final AbstractPlotReportItem plotReportItem) {
        // include generated graphics
        if (plotReportItem.getTemporaryRasterGraphicFilename() != null) {
            content += "<a href=\"file:///" + plotReportItem.getTemporaryVectorGraphicFilename() + "\">"
                    + "<img src=\"file:///" + plotReportItem.getTemporaryRasterGraphicFilename() + "\"/>" + "</a><br/>";
        }
    }
