...
/**
 * Activator class for the R plug-in. The activator class controls the plug-in life cycle.
 */
public class RVisualisationPlugin extends AbstractUIPlugin {
    ...
    public static void log(final int severity, final String message) {
        Status status = new Status(severity, PLUGIN_ID, message, new Throwable());
