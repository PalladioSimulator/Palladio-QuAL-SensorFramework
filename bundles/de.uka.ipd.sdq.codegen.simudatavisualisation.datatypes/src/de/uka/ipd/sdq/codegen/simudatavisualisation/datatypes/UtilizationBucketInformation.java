...
/**
 * This class contains the information about one bucket of a Utilization. It stores the value at
 * which a bucket starts and the Utilization for that bucket.
 * 
 * @author admin
 * @author khameershaik
...
public class UtilizationBucketInformation {
     ...
     * 
     * @param probability
     *            the new utilization for the bucket.
     */
