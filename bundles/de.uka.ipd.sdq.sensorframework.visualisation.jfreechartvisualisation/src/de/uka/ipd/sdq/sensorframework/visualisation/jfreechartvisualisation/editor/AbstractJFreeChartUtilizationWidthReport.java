...
/**
 * Report for Utilization. Provides the basic Utilizations to generate Utilization and change their
 * classes width.
 * 
 * @author khameershaik
...
public abstract class AbstractJFreeChartUtilizationWidthReport extends AbstractReportView implements
    ...
    private void updateUtilizationWidth(double newWidth) {
        ...
        for (DataAdapter adapter : adapterList) {
            ...
            adapterProperties.put(StateToUtilizationAdapter.UTILIZATION_WIDTH, utilizationWidth);
    ...
    protected void generateVisualization(List<DataAdapter> newList) {
        ...
        /*
         * Set all utilization to the same utilization width and add utilization to the current
         * view.
         */
