...
public abstract class AbstractFileEntity implements SerializableEntity {
    ...
    /**
     * File DAO which controls this entity. Used to create child objects of this object by
     * subclasses
     */
     ...
     * 
     * @see
     * de.uka.ipd.sdq.sensorframework.dao.file.entities.NamedSerializable#setFactory(de.uka.ipd.
     * sdq.sensorframework.dao.file.FileDAOFactory)
     * 
