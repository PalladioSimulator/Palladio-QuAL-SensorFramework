...
public abstract class AbstractFileDAO<T> {
     ...
     *            Interface to other DAOs
     * @param idGen
     *            Identifier Generator used for new elements
     * @param prefix
     *            Filename prefix for the filename used to persist the elements controlled by this
     *            DAO
     */
    ...
    /**
     * Load all elements controlled by this DAO into memory. Called on startup to initialise this
     * DAO
     */
     ...
     * 
     * @param id
     *            ID of the element to retrieve. The element with ID id has to exist otherwise an
