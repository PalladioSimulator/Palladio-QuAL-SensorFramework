...
public interface IExperimentDAO {
     ...
     * @param doCascade
     *            should the remove cascade down to children and remove them aswell
     */
     ...
     * 
     * @return A collection of matching experiment. The collection might be empty, but must not be
     *         null.
     * 
     */
    java.util.Collection<de.uka.ipd.sdq.sensorframework.entities.Experiment> findByExperimentName(String searchKey);
