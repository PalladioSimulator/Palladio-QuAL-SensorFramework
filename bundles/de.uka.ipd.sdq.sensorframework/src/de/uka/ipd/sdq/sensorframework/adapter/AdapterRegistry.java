...
/**
 * This registry can store adapter factories (cf. interface {@link IAdapterFactory}), but cannot
...
public class AdapterRegistry {
    ...
    public boolean canAdapt(Object adaptee, Class<?> targetClass) {
        // inefficient: iterate over factories and if one is found, abort immediately, returning
        // true
