...

{
    ...
    public AbstractExperiment(de.uka.ipd.sdq.sensorframework.entities.dao.IDAOFactory myFactory) {
    ...
    String p_sensorname) {
        ...
        de.uka.ipd.sdq.sensorframework.entities.StateSensor result = myDAOFactory.createSensorDAO().addStateSensor(
    ...
    String p_sensorname) {
        ...
        de.uka.ipd.sdq.sensorframework.entities.TimeSpanSensor result = myDAOFactory.createSensorDAO()
                .addTimeSpanSensor(
    ...
    String p_sensorname) {
        ...
        de.uka.ipd.sdq.sensorframework.entities.ScalabilitySensor result = myDAOFactory.createSensorDAO()
    ...
    String p_experimentdatetime) {
        ...
        de.uka.ipd.sdq.sensorframework.entities.ExperimentRun result = myDAOFactory.createExperimentRunDAO()
                .addExperimentRun(
