...
public interface IAdapterFactory {
     ...
     *            The object to adapt
     * @param targetClass
     *            The class of the required adapter output
     ...
     * 
     * @param adaptee
     *            The data source to adapt
     * @return A data adapter which adapts the given data source
     */
    DataAdapter getAdapter(Object adaptee);

    /**
     * Get a descriptive label of the metric computed by adapters created by this factory, e.g.,
     * ResponseTime or Throughput
     * 
