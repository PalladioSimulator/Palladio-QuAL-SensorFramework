...
public class OpenDatasourceWizard extends Wizard {
    ...
    public void addPages() {
        ...
        selectDatasourceTypePage = new WizardSelectDatasourcePage("Select Type of Datasource to load", false, true,
                true);
        this.addPage(selectDatasourceTypePage);

        db40DatasourceLoadPage = new WizardDatasourceLoadPage("Open the database file", IResource.FILE);
        this.addPage(db40DatasourceLoadPage);

        fileDatasourceLoadPage = new WizardDatasourceLoadPage("Open the database folder", IResource.FOLDER);
    ...
    public boolean performFinish() {
        ...
        if (selectDatasourceTypePage.getResult().equals(WizardSelectDatasourcePage.FILE_DATASRC)) {
    ...
    public IWizardPage getNextPage(IWizardPage page) {
        ...
        if (page instanceof WizardSelectDatasourcePage) {
            ...
            if (data_type_page.getResult().equals(WizardSelectDatasourcePage.FILE_DATASRC)) {
