...
public class WizardSelectDatasourcePage extends WizardPage {
	...
	public static String EMF_DATASRC = "EMF Datasource";
	
	private Combo myCombo;
	protected String result = "";
	private String pageName;
	private boolean memoryEntry, db40Entry, fileEntry, emfEntry;

	protected WizardSelectDatasourcePage(String pageName, boolean memoryEntry,
			boolean db40Entry, boolean fileEntry, boolean emfEntry) {
		super(pageName);
		this.pageName = pageName;
		this.memoryEntry = memoryEntry;
		this.db40Entry = db40Entry;
		this.fileEntry = fileEntry;
		this.emfEntry = emfEntry;
	}
	...
	public boolean canFlipToNextPage() {
		...
		canFlip = canFlip
				&& (myCombo.getText().equals(FILE_DATASRC) || myCombo.getText().equals(EMF_DATASRC));
