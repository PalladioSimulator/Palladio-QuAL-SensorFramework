...
/**This class stores the information necessary to display a Utilization.
 * The Utilization can be visualized using the information about the bucket
 * width and the Utilization for the buckets.
 * @author khameershaik
 */
public class Utilization {
	 ...
	 * @param title Title od name of the Utilization.
	 */
	 ...
	 * @param title Title or name of the Utilization.
	 * @param bucketWidth Width of a bucket of the Utilization.
	 */
