...
/**
 * This class contains the information about one bucket of a histogram. It stores the value at which
 * a bucket starts and the probability for that bucket.
 * 
 * @author admin
 * @author groenda
...
public class HistogramBucketInformation {
     ...
     * 
     * @param probability
     *            the new probability for the bucket.
     */
